...
TEST_CASE("pseudoflow_marvin", "[pseudoflow][marvin]")
{
    // inputs 
    std::string valueFile = "marvin/marvin.upit";
    std::string precFile = "marvin/marvin.prec";
    double objectiveValue = 1'415'655'436;
