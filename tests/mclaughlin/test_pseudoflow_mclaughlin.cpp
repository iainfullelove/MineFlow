...
TEST_CASE("pseudoflow_mclaughlin", "[pseudoflow][mclaughlin]")
{
    // inputs 
    std::string valueFile = "mclaughlin/mclaughlin.upit";
    std::string precFile = "mclaughlin/mclaughlin.prec";
    double objectiveValue = 1'495'886'962;
