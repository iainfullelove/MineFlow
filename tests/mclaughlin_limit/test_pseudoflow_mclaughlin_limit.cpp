...
TEST_CASE("pseudoflow_mclaughlin_limit", "[pseudoflow][mclaughlin_limit]")
{
    // inputs 
    std::string valueFile = "mclaughlin_limit/mclaughlin_limit.upit";
    std::string precFile = "mclaughlin_limit/mclaughlin_limit.prec";
    double objectiveValue = 1'495'726'474;
