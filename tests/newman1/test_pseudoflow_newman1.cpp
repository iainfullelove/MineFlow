...
TEST_CASE("pseudoflow_newman1", "[pseudoflow][newman1]")
{
    // inputs 
    std::string valueFile = "newman1/newman1.upit";
    std::string precFile = "newman1/newman1.prec";
    double objectiveValue = 26'086'899;
