...
TEST_CASE("pseudoflow_zuck_medium", "[pseudoflow][zuck_medium]")
{
    // inputs 
    std::string valueFile = "zuck_medium/zuck_medium.upit";
    std::string precFile = "zuck_medium/zuck_medium.prec";
    double objectiveValue = 1'075'124'490;
