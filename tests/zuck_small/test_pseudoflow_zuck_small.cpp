...
TEST_CASE("pseudoflow_zuck_small", "[pseudoflow][zuck_small]")
{
    // inputs 
    std::string valueFile = "zuck_small/zuck_small.upit";
    std::string precFile = "zuck_small/zuck_small.prec";
    double objectiveValue = 1'422'726'898;

    // initialise pseudoflow input data structures
    uint64 numNodesPseudoFlow = 0;
    uint64 numArcsPseudoFlow = 0;
    uint64 sourcePseudoFlow = 0;
    uint64 sinkPseudoFlow = 0;
